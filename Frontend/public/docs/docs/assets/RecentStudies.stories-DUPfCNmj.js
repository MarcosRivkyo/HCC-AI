...
- Modal de confirmación para eliminar.
        `}}}},d={args:{mockData:{paginaActual:1,estudiosPaginados:[{id:"1",studieName:"Estudio Hepático 01",status:"Finalizado",studieDate:{toDate:()=>new Date("2024-01-15T14:30:00")}},{id:"2",studieName:"Control Quirúrgico",status:"En Progreso",studieDate:{toDate:()=>new Date("2024-02-20T09:00:00")}}],estudiosFiltrados:[{id:"1",studieName:"Estudio Hepático 01",status:"Finalizado",studieDate:{toDate:()=>new Date("2024-01-15T14:30:00")}},{id:"2",studieName:"Control Quirúrgico",status:"En Progreso",studieDate:{toDate:()=>new Date("2024-02-20T09:00:00")}}]}},parameters:{docs:{description:{story:"Estudios recientes simulados con opciones de filtro, acciones y eliminación."}}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    mockData: {
      paginaActual: 1,
      estudiosPaginados: [{
...
}`,...d.parameters?.docs?.source}}};const Y=["Default"];export{d as Default,Y as __namedExportsOrder,X as default};
